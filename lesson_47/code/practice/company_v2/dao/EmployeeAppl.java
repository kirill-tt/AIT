...
public class EmployeeAppl {
    public static void main(String[] args) {
        ...
        empl[0] = new Manager(100, "John", "Smith", 45, 160, 10, "Master's ",5000, 5);
        empl[1] = new SalesManager(101,"Anna", "Black", 36, 160, 8,"Bachelor's",25000, 0.1);
        empl[2] = new SalesManager(102,"Thomas", "White", 28, 160, 9,"Bachelor's",30000, 0.1);
        empl[3] = new Worker(103, "Gans", "Bauer", 30, 80, 4,"Secondary technical",5);
...
//        e[3] = new Worker(104, "Gans", "Bauer", 30, 80, 5);
        ...
        System.out.println("\nEmployees Sorted by Work Experience:");
        for (Employee e : empl) {
            System.out.println(e.getFirstName() + " " + e.getLastName() +
                    ", Work Experience: " + e.getWorkExperience() +
                    " years, Education: " + e.getEducation());
        }
