...
class CompanyImplTest {
    ...
    @BeforeEach
    void setUp() {
        company = new CompanyArrayListImpl(  5); // создан объект класса CompanyImpl
        e = new Employee[4];
        e[0] = new Manager(101, "John", "Smith", 45, 160, 10, "Master's ",5000, 5);
        e[1] = new SalesManager(102, "Anna", "Black", 36, 160, 8,"Bachelor's",25000, 0.1);
        e[2] = new SalesManager(103, "Thomas", "White", 28, 160, 9,"Bachelor's",30000, 0.1);
        e[3] = new Worker(104, "Gans", "Bauer", 30, 80, 4,"Secondary technical",5);
    ...
    void addEmployee() {
        ...
        Employee employee1 = new Manager(105, "Ivan", "Dubin", 55, 160, 6,"Master's ",6000, 6); // создали нового сотрудника
        ...
        Employee employee2 = new Manager(106, "Peter", "Dubin", 55, 160, 6,"Master's ",6000, 6); // создали нового сотрудника
