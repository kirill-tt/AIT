...
class ArchiveImplTest {
    ...
    void removeDocumentTest() {
        ...
        assertFalse( archive.removeDocument( 5, 1 ) );// такого document нет
        // проверка количества
    ...
    @Test
    void getAllDocumentFromArchiveFoldersTest() {
        Documents[] expected = {doc[3], doc[4], doc[5]};// это documents из docFoldersId = 2
        Documents[] actual = archive.getAllDocumentFromArchiveFolders( 2 );// выбрали document  из docFoldersId = 2
    ...
    void getAllDocumentFromArchiveTest() {
        Documents[] actual = archive.getAllDocumentFromArchive();
        Arrays.sort( actual );
        Documents[] expected = {doc[0], doc[1], doc[2], doc[3], doc[4], doc[5]};
        assertArrayEquals( expected, actual );
    }
