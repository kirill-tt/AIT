package practice.currency;

import practice.currency.dao.CurrencyConverter;
import practice.currency.dao.CurrencyConverterImpl;
import practice.currency.model.Currency;
import practice.currency.model.Menu;
        ...
        while (!exitFlag) {
            ...
            switch (menuOption) {
                ...
                case REPORT:
                    ...
                    converter.saveTransactionsToFile(null, defaultReportFilePath); // Передайте список валют, если необходимо
